        ...
        try:
            response = client.models.generate_content(
                ...
                config=types.GenerateContentConfig(
                    ...
                    tools=[
                        open_website, play_youtube_video, remember,
                        click_on_screen_text, scroll_screen, close_current_tab,
                        press_key, type_text, click_skip_ad,
                        web_search, news_search, set_reminder
                    ]
                )
            )
